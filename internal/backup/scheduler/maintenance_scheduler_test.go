...
func (m *mockMaintenanceRepo) ListMaintenanceJobsPaginated(ctx context.Context, orgID uuid.UUID, filter domain.MaintenanceJobFilter) ([]*domain.MaintenanceJob, bool, error) {
